...
public sealed partial class MainWindow : Window
{
    ...
    private readonly SemaphoreSlim _zoomUpdateLock = new(1, 1);
    ...
    {
        await _zoomUpdateLock.WaitAsync();
        try
        {
        ...
        finally { _zoomUpdateLock.Release(); }
    }
    ...
    private async Task<bool> ShowSettingsAsync()
    {
        ...
        try
        {
            ...
            if (changedUrl && _browser != null) await RefreshAsync();
            return true;
        }
        catch (Exception ex)
        {
